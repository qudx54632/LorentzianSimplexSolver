...
# ============================================================
# SpinfoamGeometry include order (DO NOT REORDER)
# ============================================================

include("utils/PrecisionUtils.jl")
include("algebra/SpinAlgebra.jl")
include("geometry/SimplexGeometry.jl")
include("geometry/TetraNormals.jl")
include("geometry/DihedralAngles.jl")
include("algebra/LorentzGroup.jl")
include("geometry/ThreeDTetra.jl")
include("geometry/volume.jl")
include("algebra/Su2Su11FromBivector.jl")
include("algebra/XiFromSU.jl")
include("geometry/FaceNormals3D.jl")
include("geometry/KappaFromNormals.jl")
include("geometry/GeometryTypes.jl")          # defines GeometryDataset, GeometryCollection
include("pipeline/GeometryPipeline.jl")
include("pipeline/GeometryConsistency.jl")
include("pipeline/KappaOrientation.jl")
include("pipeline/FourSimplexConnectivity.jl")
include("pipeline/FaceXiMatching.jl")
include("pipeline/FaceMatchingChecks.jl")
include("pipeline/GaugeFixing.jl")
include("action/CriticalPoints.jl")
include("utils/DefineSymbols.jl")
include("action/DefineAction.jl")
include("action/SolveVars.jl")
include("action/SymbolicToJulia.jl")
include("action/EOMsHessian.jl")
